    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, help_text='Your phone number (optional).', max_length=20, null=True)),
                ('registration_date', models.DateTimeField(auto_now_add=True)),
                ('launch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registrations', to='admin_panel.upcominglaunch')),
            ],
            options={
                'verbose_name': 'Launch Registration',
                'verbose_name_plural': 'Launch Registrations',
                'ordering': ['-registration_date'],
                'unique_together': {('launch', 'email')},
            },
        ),
    ]
